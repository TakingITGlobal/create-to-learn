      ...
      >
        ...
        <Box sx={{ paddingBottom: '1rem' }}>
          <Typography>
            ...
            auctor. Diam phasellus vestibulum lorem sed risus ultricies
            tristique nulla. Orci phasellus egestas tellus rutrum. Volutpat sed
            cras ornare arcu dui vivamus arcu felis bibendum. Cras sed felis
        ...
        <Typography>
          ...
          lorem ipsum dolor sit. Fames ac turpis egestas integer eget aliquet
          nibh praesent. Velit aliquet sagittis id consectetur purus ut
          faucibus. Ipsum suspendisse ultrices gravida dictum fusce. Sit amet
          venenatis urna cursus eget nunc scelerisque viverra. Viverra nibh cras
  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ paddingBottom: '1rem' }}>
          <Typography>
            This privacy policy describes how TakingITGlobal ("we", "us" or
            "our") collects, uses and discloses personal information in the
            course of operating our organization, including in connection with
            administering programs and services and operating our websites at
            www.tigweb.org, www.tiged.org, www.risingyouth.ca, www.whose.land,
            www.codetolearn.ca, www.connectednorth.org, www.youthmovements.org,
        ...
        <Typography>
          ...
          Becoming a Member. TakingITGlobal collects personal information when
          you register as a TakingITGlobal member. The information we collect
          when you register includes your name, e- mail address, city,
      ...
      >
        ...
        <Box sx={{ paddingBottom: '1rem' }}>
          ...
          <Typography>
            ...
            review the most current version of the TOS at any time at: https://
